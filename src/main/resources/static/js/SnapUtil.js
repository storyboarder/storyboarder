define([], function() {
  ...
  var gridSnap = {
    ...
    snap: function(pt) {
      ...
      return {x: _snap(pt.x), y: _snap(pt.y)};
    },
  };
  ...
  var panelGridSnap = {
    ...
    snap: function(value) {
      ...
      return {x: _snap("x", value.x), y: _snap("y", value.y)};
    },
  ...
  return {
    ...
    snapBorders: function(borders, control) {
      var snapped = {
        left: snapPointIfClose({x: borders.left}).x,
        right: snapPointIfClose({x: borders.right}).x,
        top: snapPointIfClose({y: borders.top}).y,
        bottom: snapPointIfClose({y: borders.bottom}).y,
      };
